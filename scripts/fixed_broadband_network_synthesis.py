...
Manager.add_pcp((-1.844580, 52.692175), {'Name': 'cab8', 'Type': 'pcp'})
Manager.add_link(([( -1.844580, 52.692175), (0, 52), ( 0.802002, 51.154586)]), {'Origin': 'CoreNode', 'Dest': 'cab8', 'Type': 'link','Physical': 'fiberglass'})
