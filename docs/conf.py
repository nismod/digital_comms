...
sys.path.insert(0, os.path.join(__location__, '../digital_comms'))
...
module_dir = os.path.join(__location__, "../digital_comms")
try:
...
try:
    from digital_comms import __version__ as version
except ImportError:
    pass
else:
    release = version
